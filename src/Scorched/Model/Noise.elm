module Scorched.Model.Noise exposing (..)
...
generator time = Random.constant (rounds time)
...
perm x =
  let
    ...
    arrPermutations = Array.fromList (List.append permutations permutations)
  in
    case Array.get x arrPermutations of
      Just n -> n
      Nothing -> 0
